...
$data = file_get_contents("oders.html");
$old = "<!--Addhere-->";

if (strpos($utm_source, 'google') !== false) // именно через жесткое сравнение
{
    $new = "<tr style='background-color: #e1cdf6;'><td>$user_phone</td><td>$utm_source</td><td>$utm_medium</td><td>$utm_campaign</td><td>$utm_term</td><td>$utm_content</td><td>$utm_keyword</td><td>1.kuhni</td></tr>\n<!--Addhere-->";
} else {
    $new = "<tr><td>$user_phone</td><td>$utm_source</td><td>$utm_medium</td><td>$utm_campaign</td><td>$utm_term</td><td>$utm_content</td><td>$utm_keyword</td><td>1.kuhni</td></tr>\n<!--Addhere-->";
}
if (strpos($utm_source, 'vkontakte') !== false) // именно через жесткое сравнение
{
    $new = "<tr style='background-color: #f6cddc;'><td>$user_phone</td><td>$utm_source</td><td>$utm_medium</td><td>$utm_campaign</td><td>$utm_term</td><td>$utm_content</td><td>$utm_keyword</td><td>1.kuhni</td></tr>\n<!--Addhere-->";
}else {

}
$newdata = str_replace($old, $new, $data);
file_put_contents("oders.html", $newdata);
